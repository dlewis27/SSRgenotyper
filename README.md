...
**-P --PopUnitsMin** The minimum SSR repeat number allowed within the population. This should be smaller than the --RefUnits. We typically use --REfUnits - 1.  This parameter allows individuals within the population to have a smaller repeat number than the reference repeat number. [3]\
...
**-Q --QualityFilter** Only Reads with the equal to or greater than the specified mapping quality are used to support genotype calling. [45]\
