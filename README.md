...
**-P --PopUnits** The minimum SSR repeat number allowed within the population. This should be smaller than the --RefUnits. We typically use --REfUnits - 1.  This parameter allows some of the population to have a smaller repeat number than the reference. [3]\
