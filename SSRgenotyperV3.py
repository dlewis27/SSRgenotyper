...
parser.add_argument("-B", "--BoarderSeq", help = "The number of boardering nucleotides on each side of the SSR that must match the reference for a read to be used to support an allelic call (default = 20)", type=int, default= 20)
